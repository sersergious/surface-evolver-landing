...
const platforms = [
  {
    ...
    badge: "DMG",
    features: ["Native WKWebView rendering", "Apple Silicon (arm64)", "macOS 13+"],
  },
  {
    name: "Linux",
    subtitle: "x86-64",
...
export default function Download() {
  return (
    <section id="download" className="bg-base-200 py-24 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16 space-y-3">
          ...
          <p className="text-base-content/60 max-w-xl mx-auto">
            Free and open source. No account required. Unsigned builds — you
            may need to approve the app on first launch.
          </p>
        </div>
              ...
              <div className="card-body items-center text-center gap-5">
                ...
                <div>
                  <div className="flex items-center justify-center gap-2 mb-1">
                    ...
                    <span className="badge badge-sm badge-ghost">{badge}</span>
                  </div>
